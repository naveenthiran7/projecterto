...
<div id="wrapper">
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="/RTO/about.php">About</a></li>
		...
		<div id="sidebar">
			<ul>
				<li id="search">
					<h2>About Us</h2>
						<div>
This Driving school is established in 1975 with 5 staffs and one branch.  Now it is functioning all over the city with more than 100 staffs with well deserved training to peoples.
